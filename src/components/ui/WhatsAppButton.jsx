...
import { cleanPhoneNumber, buildWhatsAppURL } from '../../lib/whatsapp'
import toast from 'react-hot-toast'

/**
 * WhatsApp click-to-chat button.
 * Opens wa.me in a new tab and logs an activity entry.
 *
 * Props:
 *   phone         - raw or clean phone string
...
export default function WhatsAppButton({ phone, messageText, session, recordName, style }) {
  ...
  const handleClick = async (e) => {
    ...
    const url = buildWhatsAppURL(cleanNumber, messageText)
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={isDisabled}
      title={isDisabled ? 'Add a phone number to enable WhatsApp' : 'Open WhatsApp chat'}
      style={{
        display: 'inline-flex',
        alignItems: 'center',
        ...
        background: isDisabled ? '#e2e8f0' : '#25D366',
